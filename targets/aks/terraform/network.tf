...
# Azure CNI needs a pre-authorized control-plane identity for the existing node subnet. This is not Kubernetes Workload Identity or an OIDC federation path.
